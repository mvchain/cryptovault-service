...
public interface CommonAddressMapper extends MyMapper<CommonAddress> {
    ...
    @Select("SELECT t1.* from common_address t1, common_token t2 WHERE t1.token_type = t2.token_name and t1.balance > t2.hold and t1.balance > t2.transafer_fee and user_id > 0 and t1.address_type != 'ETH'")
